...
class label_tool(qtw.QWidget):
    ...
    def __init__(self):
        ...
        # self.data_directory = os.path.join(self.wk_directory, 'data')
        # self.label_directory = os.path.join(self.wk_directory, 'label')
        # self.data_file = '987654321.fif'

        # drop file extension
        # self.epoch_index = os.path.splitext(self.data_file)[0]
        # self.data = mne.read_epochs(os.path.join(self.data_directory, self.data_file))

        # label file
        # self.label_directory = os.path.join(self.wk_directory, 'label')
        # self.label_file = os.path.join(self.label_directory, 'label.json')
        ...
        self.layout.addWidget(self._import_folder_widget(), 2, 0, 1, 2)
    ...
    def _import_folder_widget(self):
        ...
        self.import_folder_layout.addWidget(self.import_folder_bt, 0, 0)
        self.import_folder_layout.addWidget(self.import_folder_confirm_bt, 0, 1)
    ...
    def _user_login_widget(self):
        ...
        self.user_combo.addItems(["User 1", "User 10"])

        # add button and combo to the widget
        self.user_login_layout.addWidget(self.user_login_bt, 0, 0)
        self.user_login_layout.addWidget(self.user_combo, 0, 1)
    ...
    def _choose_label_widget(self):
        ...
        self.submit_bt.clicked.connect(self.submit_label)
    ...
    def submit_label(self):
        ...
        # self.label_dict[self.epoch_index] = self.label

        with open(self.label_file, 'w') as f:
            json.dump(self.label_dict, f)

        # print(self.epoch_index)
